...
def check_sufficient_data(county_data):
    ...
    Parameters
    ----------
    county_data : Pandas Series
        Contains COVID-19 cases data for a county or state.

    Returns
    -------
    enough_data : Boolean
        Flag whether there is sufficient data for curve fitting.
...
def read_data(file_path='./data/covid_confirmed_usafacts.csv', county_file_path='./data/county_data.csv'):
    ...
    file_path : String, optional
        path for csv file of covid confirmed cases from USAFacts. The default is './data/covid_confirmed_usafacts.csv'.
    county_file_path : String, optional
        path for csv file of information on counties. The default is './data/county_data.csv'.
...
##############################################################################
data, county_data = read_data(file_path='./data/covid_confirmed_usafacts.csv')
